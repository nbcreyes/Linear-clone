  ...
  return (
    <div className="w-60 h-screen bg-[#141414] border-r border-[#2e2e2e] flex flex-col select-none">
      ...
      <div className="p-2 border-t border-[#2e2e2e] space-y-0.5">
        ...
        <button
          onClick={() => {}}
          className="w-full flex items-center justify-between px-3 py-1.5 rounded text-sm text-[#4a4a4a] hover:text-[#8a8a8a] transition-colors"
        >
          <span>Shortcuts</span>
          <kbd className="px-1.5 py-0.5 bg-[#1a1a1a] border border-[#2e2e2e] rounded text-[10px] font-mono">
            ?
          </kbd>
        </button>
      </div>
